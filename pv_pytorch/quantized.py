...
class PlantVIT(nn.Module):
    def __init__(self, image_shape = (3, 256, 256), patch_shape = (32, 32), num_classes = 2, hidden_dim = 32, depth=3, heads =3, mlp_dim = 8, pool = 'cls', dim_head = 64, dropout = 0., emb_dropout = 0., quantized = False):
        # Super constructor
        super().__init__()
...
#         self.linear_mapper = nn.Linear(self.input_d, self.hidden_d)
        ...
        for _ in range(depth):
            ...
            self.layers.append(FeedForward(dim, mlp_dim, dropout = dropout))
                
        #self.transformer = Transformer(hidden_dim, depth, heads, dim_head, mlp_dim, dropout, quantized = quantized)
